Feature: BBPS - Hospital and Pathology category

  @sprint14 @epic-3580 @SP-4628 @TC_02 @TC_03
  Scenario: To check whether when user select Hospital and Pathology then verify dropdown
